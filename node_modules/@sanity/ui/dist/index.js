...
const CLEAR_BUTTON_BOX_STYLE = {
  ...
  forwardedAs: "span"
})(textInputRootStyle), InputRoot = styledComponents.styled.span`
  flex: 1;
  min-width: 0;
  display: block;
  position: relative;
`, Prefix = styledComponents.styled(Card).attrs({
  forwardedAs: "span"
})`
...
`, Input = styledComponents.styled.input(responsiveInputPaddingStyle, textInputBaseStyle, textInputFontSizeStyle), Presentation = styledComponents.styled.span(responsiveRadiusStyle, textInputRepresentationStyle), LeftBox = styledComponents.styled(Box)`
  position: absolute;
  top: 0;
  left: 0;
...
function Toast(props) {
  ...
  let t2;
  $[11] !== description ? (t2 = description && /* @__PURE__ */ jsxRuntime.jsx(Text, { muted: !0, size: 1, children: description }), $[11] = description, $[12] = t2) : t2 = $[12];
  let t3;
  $[13] !== t1 || $[14] !== t2 ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(TextBox, { flex: 1, padding: 3, children: /* @__PURE__ */ jsxRuntime.jsxs(Stack, { space: 3, children: [
    t1,
    t2
